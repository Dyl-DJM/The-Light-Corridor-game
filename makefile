...
# Main module
OBJ_MAIN= $(OBJ_TOOLS) $(OBJDIR)animation.o $(OBJDIR)draw_scene.o $(OBJDIR)types.o $(OBJDIR)obstacle.o $(OBJDIR)affichage_graphique.o $(OBJDIR)menu.o $(OBJDIR)jeu.o  $(OBJDIR)window.o $(OBJDIR)regles.o $(OBJDIR)main.o 
